...
<title>SisImagem - Incluir Documento PAPEM-42</title>
...
<div class="divisao incluirDocumento" >
	...
	<label>Tipo Registro</label>&nbsp;
	 ...
	 <%if(documento.getRecordType()!= null&&( documento.getRecordType().equals("4") || documento.getRecordType().equals("12")) ){%>
	  ...
	  <div class="divsLabel meioClass topo0">
		<label>Classificação</label>&nbsp;		
			<input type="text" size="42" name="classificacao" id="classificacao" readonly="readonly" value="<jsp:getProperty property="classificacao" name="documento"/>" />
	  </div>
		...
		<input type="text" size="21" name="recordNumber" id="recordNumber" readonly="readonly" value="<jsp:getProperty property="recordNumber" name="documento"/>" />
		</div>
		...
		<input id="nipMatricula" size="13" type="text" name="nipMatricula" maxlength="9" value="<jsp:getProperty property="nipMatricula" name="documento"/>"/>
		</div>
				
		<div class="divsLabel meioCPF topo120">
		<label>CPF</label> &nbsp;
		<input type="text" size="25" name="cpf" id="cpf" class="inputMenor" value="<jsp:getProperty property="cpf" name="documento"/>"/>
		</div>
								 
		<div class="divsLabel esquerda topo160">
		<label>Consignado</label> &nbsp;
		<input type="text" size="90" name="consignado" value="<jsp:getProperty property="consignado" name="documento"/>"/>
		</div>
		
		<div class="divsLabel esquerda topo200">
		<label>Beneficiário</label> &nbsp;
		<input type="text" size="90" name="beneficiario" value="<jsp:getProperty property="beneficiario" name="documento"/>"/>
		</div>
	 
		<div class="divsLabel esquerda topo200">
		<label>Título do Documento</label> &nbsp;
		<input type="text" size="82" name="title" id="title"/>
		</div>		
		...
		<input type="text" size="37" readonly ="readonly" name="responsavel" value="<%=session.getAttribute("usuario")%>"/>
		</div>
		...
		<div class="divsLabel direita topo400">
		<label>Urgente</label>&nbsp;
